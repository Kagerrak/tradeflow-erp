...
| Offline return evidence, Return Receipt/Inspection and controlled damaged custody                                       | `returns.py` evidence endpoints, migration `5db106ff1092`, mobile SQLite outbox (`return-evidence-*`), web evidence panel, and contract tests implement offline photo/note capture, resumable upload, conflict review and sync state                                                                    | Shipped: #66; Missing: #67                                                                            |
