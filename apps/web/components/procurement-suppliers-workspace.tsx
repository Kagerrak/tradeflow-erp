...
export function ProcurementSuppliersWorkspace() {
  ...
  return (
    <>
      <PageHeader
        description="Maintain the procurement supplier directory. Every supplier is scoped to the company and identified by a unique code."
        eyebrow="Procurement"
        title="Suppliers"
      />
      ...
      <section className="procurement-title card">
        ...
        <p>
          Maintain the procurement supplier directory. Every supplier is scoped
          to the company and identified by a unique code.
        </p>
      </section>
