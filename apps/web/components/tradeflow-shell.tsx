...
const navigation = [
  ...
  ["Allocations", "08", "/finance/allocations"],
  ["Statement", "09", "/finance/statement"],
  ["Procurement", "09", "/procurement"],
  ["Suppliers", "10", "/procurement/suppliers"],
  ["Purchase orders", "11", "/procurement/purchase-orders"],
] as const;
